...
[AZ-104](https://learn.microsoft.com/en-us/users/kastriotymeri-9234/transcript/dgww8fqq31gjgl3)
...
### 🔹 [4. GitHub Actions CI/CD for MERN App](https://github.com/devops-success-true/4.Github-Actions-CI-CD-pipeline-docker-images-MERN-app-e-Commerce)  
- Automated pipeline with **GitHub Actions** for a MERN stack app.  
- Builds, lints, tests, and pushes Docker images.  
- Integrated security scans and workflow automation.  
✅ *Outcome: Showcases CI/CD best practices for containerized applications.*
...
- Started with **monolithic deployments** (VM + Nginx + MongoDB).  
- Migrated apps into **Docker containers** and orchestrated with Compose.  
- Automated CI/CD pipelines with **GitHub Actions**.  
- Provisioned **secure AKS & EKS clusters** with **Terraform**.  
- Enabled **GitOps (ArgoCD)** and **full observability** for production readiness.  
...
- **Cloud:** Azure, AWS  
- **IaC:** Terraform  
- **Kubernetes:** AKS, EKS, K3s, Helm, ArgoCD  
...
- 🐙 [GitHub](https://github.com/devops-success-true)  
- 📧 Email: *(your email)*  

---

⭐ **Check out the 6 repos above to see a complete DevOps journey — from monolithic to containerized apps, automated CI/CD pipelines, and production-grade Kubernetes clusters on Azure & AWS.**
